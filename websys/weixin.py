...
class WeiXin:
    ...
    def send_msg_to_all(self,content):
        pass
        api = "https://api.weixin.qq.com/cgi-bin/message/mass/sendall?access_token=%s" % (self.get_token())
        data = {
               "filter":{
                  "is_to_all":True,
                  # "tag_id":2
        ...
        return self.post_data(api,data)
...
#            }
#
# r=wx.send_template_msg('o0OdtestfaPsJ8D3kn7sateqEoqU','9Br7-3WFw10pCRJEJHLF5ZBf4Z-zOVuLOJ4qRbSwwR8',data)
# print(r)